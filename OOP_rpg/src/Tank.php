...
class Tank extends Character
{
    ...
    public function __construct(string $name, string $role, int $health, int $attack, int $defense, int $range, int $shield = 50)
    {
        ...
        $this->shield = $shield; // Initialiseer shield
        $this->originalShield = $shield; // Bewaar de originele shield waarde
    ...
    {
        $this->shield = $this->originalShield; // Reset shield naar de originele waarde
